...
export default function TambahLahirMasukPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await fetchData("/mutasi/createLahirMasuk", {
        method: "POST",
        data: {
          ...formData,
      ...
      Swal.fire({
        icon: "success",
        title: "Berhasil",
        text: "Data Lahir/Masuk berhasil ditambahkan!",
      });
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-semibold text-blue-900">
                    Tambah Data Lahir/Masuk
                  </h1>
                  <p className="text-sm text-gray-600">
                    Tambahkan data kelahiran atau pendatang baru
                  </p>
                </div>
              </div>
            </div>
          ...
          <main className="p-6 space-y-6">
            ...
            <Card className="border-0 bg-white/80 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>Masukkan detail data Lahir/Masuk</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <Select onValueChange={handleResidentChange} required>
