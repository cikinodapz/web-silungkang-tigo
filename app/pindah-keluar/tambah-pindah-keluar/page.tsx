...
export default function TambahPindahKeluarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await fetchData("/mutasi/createPindahKeluar", {
        method: "POST",
        data: {
          ...formData,
      ...
      Swal.fire({
        icon: "success",
        title: "Berhasil",
        text: "Data pindah keluar berhasil ditambahkan!",
      });
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Tambahkan data pindah keluar baru
                  </p>
                </div>
              </div>
            </div>
          ...
          <main className="p-6 space-y-6">
            ...
            <Card className="border-0 bg-white/80 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>Masukkan detail data pindah keluar</CardDescription>
              </CardHeader>
              <CardContent>
