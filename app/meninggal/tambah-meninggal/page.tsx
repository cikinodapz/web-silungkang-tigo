...
export default function TambahMeninggalPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await fetchData("/mutasi/createMeninggal", {
        method: "POST",
        data: {
          ...formData,
      ...
      Swal.fire({
        icon: "success",
        title: "Berhasil",
        text: "Data meninggal berhasil ditambahkan!",
      });
          ...
          <main className="p-6 space-y-6">
            ...
            <Card className="border-0 bg-white/80 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>Masukkan detail data meninggal</CardDescription>
              </CardHeader>
              <CardContent>
